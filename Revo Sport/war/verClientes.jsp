...
<!-- video : fondo de pantalla-->
        ...
        <div class="caja">
            ...
            <table id="t01" class= "table">
                ...
                <tr>
                    <td><%= cliente.getId() %></td>
                    <td><a href="perfilCliente?action=<%= cliente.getDocumento()%>" >perfil</a></td> 
                    <td><%= cliente.getApellidop() %> <%= cliente.getApellidom() %>, <%= cliente.getNombre() %></td>
                    <td><%= cliente.getDocumento() %></td>
                    <td><%= cliente.getTelefono() %></td>
                    <td><%= cliente.getEmail() %></td>
                    <td><%= sdf.format(cliente.getFecha()) %></td>
                    <td><a href="actualizarCliente?action=<%= cliente.getDocumento()%>" >Actualizar</a></td> 
                </tr>
                <%}%>
