...
<center>
    <div class="caja">
        <li class="cliente"><h2>Buscar Administrador</h2><li>
        <hr>
        <form  method="post">
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td><input type="text" name="dni" id="dni" maxlength="8" pattern="[0-9]{8}" title="Ingrese solo numeros">
                        <td> 
