...
<%@page import="beans.*" %>
<% List<Trainer> trainer = (List<Trainer>)request.getAttribute("verTrainer");%>
<%
  ...
  <header>
		<nav class="menu">
			<ul>
				...
				<li><a>MODIFICAR USUARIOS</a>
                    <ul>
                        <li><a href="actualizarAdmi?action=red" class="design-name">MODIFICAR ADMINISTRADOR</a></li>
                        <li><a href="actualizarSecretaria?action=red" class="design-name">MODIFICAR RECEPCIONISTA</a></li>
                        <li><a href="actualizarMedico?action=red" class="design-name">MODIFICAR MEDICO</a></li>
                        <li><a href="actualizarTrainer?action=red" class="design-name">MODIFICAR TRAINER</a></li>
                        <li><a href="actualizarCliente?action=red" class="design-name">MODIFICAR CLIENTE</a></li>
                        <li><a href="actualizarDisciplina?action=red" class="design-name">MODIFICAR DISCIPLINA</a></li>
                    </ul></li>
...
<!-- video : fondo de pantalla-->
        ...
        <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br><br><br><br>
           ...
           <center> 
    <div class="caja">
        <li class="title"><h2>Lista de todos los Trainers</h2></li>
        <hr>
        ...
        <table id="t01" class= "table">
            ...
            <%for (int i = 0; i < trainer.size(); i++) {
                Trainer admi = (Trainer)trainer.get(i);%>
            <tr>
                <td><%= admi.getId() %></td>
                <td><a href="perfilTrainer?action=<%= admi.getdni()%>" >perfil</a></td>
                ...
                <td><a href="actualizarTrainer?action=<%= admi.getdni()%>" >Actualizar</a></td>
            </tr>
            <%}%>
