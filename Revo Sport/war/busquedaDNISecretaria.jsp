...
<% 
List<Secretaria> secretaria = (List<Secretaria>)request.getAttribute("secretaria");
%>
<%
...
<body>
    ...
    <center>
        ...
        <div class="caja">
        <li class="cliente"><h2>Secretarias(os) encontrados por DNI</h2></li>
        <hr>
        <br>
    ...
    Secretaria h = (Secretaria)secretaria.get(i);%>
