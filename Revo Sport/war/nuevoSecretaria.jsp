...
<body>
	...
	<center>
		<div class="caja">
			<form class="contact_form" action="/registrarSecretaria"
				method="post">
				<li class="cliente">
					<h2>REGISTRO PARA CREAR UN NUEVO SECRETARIO</h2>
				</li>
				<div id='izquierda'>
					<ul>
						...
						<li><label>nombre*</label> <input type="text" name="nombre"
							required id="codigo" placeholder="Juana"></li>
						<li><label>Apellido Paterno*</label> <input type="text"
							name="apellidoP" required
							pattern="([a-zA-Z�����]+[\s]*[a-zA-Z�����]*)"
							title="Ingrese solo letras" id="pat" placeholder="Perez"></li>
						<li><label>Apellido Materno*</label> <input type="text"
							name="apellidoM" required
							pattern="([a-zA-Z�����]+[\s]*[a-zA-Z�����]*)"
							title="Ingrese solo letras" id="mat" placeholder="Aguilar"></li>
						<li><label>Fecha Nacimiento*</label> dia: <input
							type='number' min="1" max="31" placeholder="dd" required
							title="Ingrese solo numeros" class='fecha' name='dia' id='dia' />
							mes: <input type='number' min="1" max="12" placeholder="mm"
							required title="Ingrese solo numeros" class='fecha' name='mes'
							id='mes' /> anio: <input type='number' min="1900" max="2016"
							placeholder="aaaa" required title="Ingrese solo numeros"
							class="fecha" name='anio' id='alo' /></li>

						<li><label>DNI*</label> <input type="text" name="documento"
							maxlength="8" required pattern="[0-9]{8}"
							title="Ingrese solo numeros" id="dni" placeholder="12345678"></li>


						<li><label>Estado Civil *:</label> <input required
							type="radio" class="numero" name="estado" value="Soltero">Soltero
							<br> <input type="radio" class="numero" name="estado"
							value="Casado">Casado <br> <input type="radio"
							class="numero" name="estado" value="Viudo">Viudo <br>
							<input type="radio" class="numero" name="estado"
							value="Divorciado">Divorciado <br></li>
				...
				<div id='derecha'>
					...
					<ul>
						...
						<li><label>Sexo*:</label> Femenino <input type="radio"
							class="anio" required name='sexo' value='femenino' id='dia' />
							Masculino <input type='radio' class="anio" name='sexo'
							value='masculino' id='dia' /></li>
						...
						<li><label for="codigo">Correo Electronico*</label> <input
							type="text" name="email" placeholder="ejemplo@ejemplo.com"
