...
<br>
    ...
    <center>
        <div class="caja">
            <form class="contact_form" action="/registrarCliente" method="post">
                <li class="cliente">
                    <h2>REGISTRO PARA CREAR UN NUEVO CLIENTE</h2>
                </li>
                <div id='izquierda'>
                    <ul>
                        ...
                        <li><label >nombre*</label> <input
                            type="text" name="nombre" required  id="codigo" placeholder="Carlos"></li>
