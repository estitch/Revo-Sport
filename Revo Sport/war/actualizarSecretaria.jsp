...
%>
<% List<Secretaria> secretarias = (List<Secretaria>)request.getAttribute("secretarias");%>
<!DOCTYPE html >
...
<% Secretaria secretaria = (Secretaria)secretarias.get(0);%>
<center>
                <div class="caja">
                    <form class="contact_form" action="/actualizarSecretaria" method="post">
                        <li class="cliente">
                        ...
                        <div id='izquierda'>
                            <ul>
                                ...
                                <li><label for="codigo">Apellido Paterno*</label> <input
                                    ...
                                    title="Ingrese solo letras" id="pat" value="<%= secretaria.getApellidop() %>"></li>

                                <li><label for="codigo">Apellido Materno*</label> <input
                                    type="text" name="materno" required
                                    pattern="([a-zA-Z�����]+[\s]*[a-zA-Z�����]*)"
                                    title="Ingrese solo letras" id="mat" value="<%= secretaria.getApellidom() %>"></li>

                                <li><label for="codigo">Nombres*</label> <input type="text"
                                    name="nombre" required
                                    pattern="([a-zA-Z�����]+[\s]*[a-zA-Z�����]*)"
                                    title="Ingrese solo letras" id="nombre" value="<%= secretaria.getNombre() %>"></li>


                                <li><label for="codigo">DNI*</label> <input type="text"
                                    name="dni" maxlength="8" required pattern="[0-9]{8}"
                                    title="Ingrese solo numeros" id="dni" readonly value="<%= secretaria.getDocumento() %>"></li>
                        ...
                        <div id='derecha'>
                            ...
                            <ul>
                                ...
                                <li><label>numero celular:</label> <input type="text"
                                    class="telefono" name="telefono" id="telefono" value="<%= secretaria.getTelefono() %>"></li>

                                <li><label for="codigo">Correo Electronico*</label> <input
                                    type="text" name="correo" value="<%= secretaria.getEmail() %>"
