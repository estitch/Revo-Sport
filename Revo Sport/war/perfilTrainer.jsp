...
<center>
    <div class="caja">
     <%Trainer trainer = (Trainer)trainers.get(0);%>
     <h1>PERFIL</h1>
        <li class="cliente"><h2><%= trainer.getApellidop() %> <%= trainer.getApellidom() %>, <%= trainer.getNombre() %></h2><li>
        <hr>
        <form  method="post">

            <fieldset>
                <legend>DATOS DEL TRAINER</legend>
                
                <table>
                <tr><td>Direccion:</td><td><%= trainer.getDireccion()%></td></tr>
                <tr><td>DNI:</td><td> <%= trainer.getdni()%></td></tr>
                <tr><td>Correo Electronico:</td><td> <%= trainer.getEmail()%></td></tr>
                <tr><td>Telefono:</td><td> <%= trainer.getTelefono()%></td></tr>
