...
%>
<% List<Admi> admis = (List<Admi>)request.getAttribute("verAdmis");%>
        ...
        <div class="trans">
           ...
           <center> <div class="caja">
            ...
            <%}%>
                ...
                <center>
        <div class="caja">
        <li class="cliente"><h2>Borrar un administrador</h2></li>
        <hr>
        <form action="/borrarAdmi" method="post">

                <table>
                    <tr>
                        <td>Ingrese numero de DNI del Administrador:</td>
