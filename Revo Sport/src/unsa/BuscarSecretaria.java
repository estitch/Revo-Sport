...
public class BuscarSecretaria extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		if (request.getParameter("action").equals("buscarDNI")) {
			...
			List<Secretaria> secretaria = BusquedaSecretariaDatos.buscardniSecretaria(dni);
			request.setAttribute("secretaria", secretaria);
			RequestDispatcher rd = getServletContext().getRequestDispatcher("/busquedaDNISecretaria.jsp");
