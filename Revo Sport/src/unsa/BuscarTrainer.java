...
import datos.BusquedaTrainerDatos;
import beans.Admi;
import beans.Trainer;

@SuppressWarnings("serial")
public class BuscarTrainer extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		if (request.getParameter("action").equals("buscarDNI")) {
			...
			List<Trainer> trainer = BusquedaTrainerDatos.buscardniTrainer(dni);
			request.setAttribute("trainer", trainer);
			RequestDispatcher rd = getServletContext().getRequestDispatcher("/busquedaDNITrainer.jsp");
