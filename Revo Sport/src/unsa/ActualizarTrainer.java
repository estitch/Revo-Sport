...
public class ActualizarTrainer extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		if (request.getParameter("action").equals("create")) {
			...
			q.declareParameters("String nombreParam");
				...
				List<Trainer> trainers = (List<Trainer>)q.execute(cod);
				...
				rd.forward(request, response);
					...
					if(es==true){
						...
						List<Trainer> trainer1 = TrainerDatos.verTrainer(dni);
						request.setAttribute("trainers", trainer1);
						RequestDispatcher rd = getServletContext().getRequestDispatcher("/actualizarTrainer.jsp");
						rd.forward(request, response);
					}
					else{
